...
public class ListHouseholdsCommandTest {
    ...
    public void execute_nonEmptyHouseholdList_success() {
        ...
        Household household1 = new Household(
                ...
                new Contact("91234567"), householdId1, new HashSet<>(Arrays.asList(new Tag("priority"))));

        HouseholdId householdId2 = new HouseholdId("H000002");
        Household household2 = new Household(
                new Name("Jane Household"), new Address("456 Side St"),
                new Contact("98765432"), householdId2, new HashSet<>(Arrays.asList(new Tag("standard"))));
    ...
    public void execute_singleHousehold_success() {
        ...
        Household household = new Household(
                ...
                new Contact("98765432"), householdId, new HashSet<>(Arrays.asList(new Tag("priority"))));
