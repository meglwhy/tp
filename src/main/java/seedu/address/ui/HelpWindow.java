...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String HELP_MESSAGE =
            "add-household: Adds a household to the household book. Parameters: n/NAME a/ADDRESS p/CONTACT\n"
                    ...
                    + "t/TIME (in HH:mm)\n"
                    + "Example: add-session id/H000001 d/2025-03-15 t/14:30\n\n"
                    + "edit-session: Edits the details of a session identified by household ID and session index."
                    + "Existing values will be overwritten.\n"
                    + "Parameters: id/HOUSEHOLD_ID-SESSION_INDEX [d/DATE] [t/TIME]\n"
                    + "Example with note: edit-session id/H000006-2 d/2025-03-16 t/15:00 n/Follow up required\n\n"
