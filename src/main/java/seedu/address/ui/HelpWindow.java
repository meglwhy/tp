...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String HELP_MESSAGE =
            "add-household: Adds a household to the household book. Parameters: n/NAME a/ADDRESS p/CONTACT\n"
                    ...
                    + "edit-household: Edits the details of the household identified by the household ID. "
                    ...
                    + "add-session: Adds a session to a household. Parameters: id/HOUSEHOLD_ID d/DATE (in YYYY-MM-DD) "
                    + "tm/TIME (in HH:mm)\n"
                    ...
                    + "Parameters: id/HOUSEHOLD_ID-SESSION_INDEX [d/DATE] [tm/TIME]\n"
                    + "Example: edit-session id/H000006-2 d/2025-03-16 tm/15:00\n\n"
                    ...
                    + "add-note: Adds a note to the specified session.\n"
                    + "Parameters: id/HOUSEHOLD_ID-SESSION_INDEX n/NOTE\n"
                    + "Example: add-note id/H000006-2 n/Follow-up on medical assistance application\n\n"
                    + "list-households: Lists all households.\n\n"
                    + "list-sessions: Lists all sessions for a specified household.\n"
                    + "Parameters: id/HOUSEHOLD_ID\n"
                    + "Example: list-sessions id/H000006\n\n"
                    + "find-household: Finds all households whose names, addresses, or tags contain any of the"
